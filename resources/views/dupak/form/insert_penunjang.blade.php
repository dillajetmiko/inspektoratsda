...
@section("page_title","Inspektorat || Penunjang")
...
@section('content')
 ...
 <div class="card">    
    <div class="card-header">
        <h3 class="card-title">Tambah Penunjang</h3>
    ...
    <!-- <h1>Tambah Data Temuan</h1> -->
      <form action="/dupak/tambah_penunjang" method="post" enctype="multipart/form-data">
        ...
        satuan_ak: <input type="text" class="form-control" name="satuan_ak"><br>
        jumlah_jam: <input type="text" class="form-control" name="jumlah_jam"><br>
